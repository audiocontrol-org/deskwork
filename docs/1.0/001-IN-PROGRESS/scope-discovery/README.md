...
| 11 | Pattern discovery loop with self-correcting controller ([#316](https://github.com/audiocontrol-org/deskwork/issues/316)) | In progress — Task 1 landed (polymorphic pattern-handler dispatcher: regex / negative-space / coverage / outlier / semantic; KeygroupSummary repro from [#315](https://github.com/audiocontrol-org/deskwork/issues/315) detected via negative-space). G5 unmatched-shape clustering stub + G6 semantic LLM wiring stub filed at [#318](https://github.com/audiocontrol-org/deskwork/issues/318) / [#319](https://github.com/audiocontrol-org/deskwork/issues/319). Tasks 2–14 remain. |
