...
| 17 | Cross-page editorial nav + studio index at `/dev/` | Not started (design mockup at [`mockups/editorial-nav-and-index.html`](mockups/editorial-nav-and-index.html)) |
