...
| 21 | End-to-end shortform composition (LinkedIn) through the longform review surface | Not started ([#47](https://github.com/audiocontrol-org/deskwork/issues/47)); plan at `~/.claude/plans/i-would-like-to-wiggly-hennessy.md` |
| 22 | Install / studio / doctor polish (issues [#41](https://github.com/audiocontrol-org/deskwork/issues/41)–[#46](https://github.com/audiocontrol-org/deskwork/issues/46)) | Not started; bundled into the same PR as Phase 21 |
