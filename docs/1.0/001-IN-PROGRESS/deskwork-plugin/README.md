...
| 19 | Separate identity (UUID) and path-encoding (frontmatter id) from slug; `deskwork doctor` validate/repair | In progress — 19a–19d complete; 19e operator verification pending ([#33](https://github.com/audiocontrol-org/deskwork/issues/33)); plan at `~/.claude/plans/i-would-like-to-wiggly-hennessy.md` |
