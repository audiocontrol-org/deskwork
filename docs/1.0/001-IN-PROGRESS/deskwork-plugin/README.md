...
| 19 | Separate identity (UUID) and path-encoding (frontmatter id) from slug; `deskwork doctor` validate/repair | PR open — [#33](https://github.com/audiocontrol-org/deskwork/issues/33), [PR #35](https://github.com/audiocontrol-org/deskwork/pull/35) (v0.7.0); 19e operator verification pending; plan at `~/.claude/plans/i-would-like-to-wiggly-hennessy.md` |
...
| 21 | End-to-end shortform composition (LinkedIn) through the unified review surface | Code complete (21a/21b/21c); doc pass complete (21d) — parent issue [#47](https://github.com/audiocontrol-org/deskwork/issues/47); plan at `~/.claude/plans/i-would-like-to-wiggly-hennessy.md` |
| 22 | Install / studio / doctor polish (issues [#41](https://github.com/audiocontrol-org/deskwork/issues/41)–[#46](https://github.com/audiocontrol-org/deskwork/issues/46)) | Code complete — bundled with Phase 21 in the same PR. Sub-issues: [#41](https://github.com/audiocontrol-org/deskwork/issues/41) install schema docs, [#42](https://github.com/audiocontrol-org/deskwork/issues/42) install pre-flight schema check, [#43](https://github.com/audiocontrol-org/deskwork/issues/43) studio EADDRINUSE handling, [#44](https://github.com/audiocontrol-org/deskwork/issues/44) doctor exit-code + verbosity, [#45](https://github.com/audiocontrol-org/deskwork/issues/45) install existing-pipeline detection, [#46](https://github.com/audiocontrol-org/deskwork/issues/46) scrapbook hierarchical-path docs verification. |
