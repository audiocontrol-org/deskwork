...
| 12 | session-end-hygiene "issues filed this session" scoping fix | [#361](https://github.com/audiocontrol-org/deskwork/issues/361) | Scoped (2026-05-29) from deskwork-plugin dogfood TF-001 — recurring #340-shaped scoping bug. Implementation pending; sibling infra friction (TF-003 + TF-004) tracked separately at [#362](https://github.com/audiocontrol-org/deskwork/issues/362). |
