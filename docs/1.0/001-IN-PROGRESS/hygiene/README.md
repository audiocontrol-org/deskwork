...
| 6 | Lifecycle integration | [#330](https://github.com/audiocontrol-org/deskwork/issues/330) | Tasks 1–3 shipped (session-end + session-start + complete TBD gate; 24 new vitest tests). Task 4 phase-parent closure gate open at [#336](https://github.com/audiocontrol-org/deskwork/issues/336); Task 5 session-end-hygiene semantic + rendering fixes open at [#340](https://github.com/audiocontrol-org/deskwork/issues/340) |
