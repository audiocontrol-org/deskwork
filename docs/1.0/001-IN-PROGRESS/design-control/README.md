...
|---|---|---|---|
| 1 | Engine-adapter seam + preflight + lo-fi wireframe kit + dual-axis allowlist lint | v1-scaffold | In progress — engine-adapter seam + preflight (task 1/8) + multi-theme sketch-kit (task 2/8) landed; allowlist lint next |
