...
|---|---|---|---|
| 1 | Engine-adapter seam + preflight + lo-fi wireframe kit + dual-axis allowlist lint | v1-scaffold | In progress — engine-adapter seam + fail-loud preflight landed (task 1/8); sketch-kit + lint next |
