...
| 11 | Tranche-organized burn-down (T1: #222 first; then T6, T2, T3, T4, T5; T7 in parallel) | T1 + T6 fix-landed; T2 fix-landed (8 of 9 issues; #215 issue 2 deferred to a separate issue); T3, T4, T5, T7 not started |
