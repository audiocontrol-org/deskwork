...
- PRD has no References/Appendix section; reference_docs[] defaulted to PRD + LAYOUT.md.
  Add this section to docs/1.0/001-IN-PROGRESS/design-control/scope-inventory/widen-runs/20260610T191806Z-b0dbba/augmented-prd.md to produce a richer manifest on re-run:
