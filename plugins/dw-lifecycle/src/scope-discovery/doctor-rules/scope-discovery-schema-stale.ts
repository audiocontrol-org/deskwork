/**
 * plugins/dw-lifecycle/src/scope-discovery/doctor-rules/scope-discovery-schema-stale.ts
 *
    ...
    if (version === undefined) {
      findings.push({
        ...
        message:
          ...
          `Schema migration path: see plugins/dw-lifecycle/src/scope-discovery/schema/${file}.schema.json.`,
      });
      continue;
    }
