/**
 * plugins/dw-lifecycle/src/scope-discovery/doctor-rules/anti-patterns-yaml-schema-violation.ts
 *
...
const FILE_REL = '.dw-lifecycle/scope-discovery/anti-patterns.yaml';
const SCHEMA_REL =
  'plugins/dw-lifecycle/src/scope-discovery/schema/anti-patterns.yaml.schema.json';
