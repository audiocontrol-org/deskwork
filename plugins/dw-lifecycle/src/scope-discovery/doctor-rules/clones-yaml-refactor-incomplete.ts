/**
 * plugins/dw-lifecycle/src/scope-discovery/doctor-rules/clones-yaml-refactor-incomplete.ts
 *
...
const REPAIR_BRANCHES: ReadonlyArray<RepairBranch> = [
  {
    ...
    hint:
      ...
      'See plugins/dw-lifecycle/src/scope-discovery/clones-yaml.refactor.ts for ' +
