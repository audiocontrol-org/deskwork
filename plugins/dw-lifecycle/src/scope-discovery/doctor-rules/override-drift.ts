/**
 * plugins/dw-lifecycle/src/scope-discovery/doctor-rules/override-drift.ts
 *
 * Doctor rule: operator advisory (NOT error / warning of misconfig)
 * when an operator's per-file scope-discovery override at
 * `.dw-lifecycle/scope-discovery/<name>.ts` diverges substantially
 ...
 * `plugins/dw-lifecycle/src/scope-discovery/`. Files whose default
...
const OVERRIDE_DIR_REL = '.dw-lifecycle/scope-discovery';
