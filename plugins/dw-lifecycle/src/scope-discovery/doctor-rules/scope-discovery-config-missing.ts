/**
 * plugins/dw-lifecycle/src/scope-discovery/doctor-rules/scope-discovery-config-missing.ts
 *
 ...
 * doc) but lack the `.dw-lifecycle/scope-discovery/` config directory
  ...
  return [
    {
      ...
      message:
        ...
        `Run /dw-lifecycle:install-scope-discovery to bootstrap the config dir.`,
    },
  ];
};
