/**
 * plugins/dw-lifecycle/src/scope-discovery/audit-barrage/config-loader.ts
 *
 * Loads the audit-barrage model battery from YAML. The project-side
 * override at `.dw-lifecycle/scope-discovery/audit-barrage-config.yaml`
...
export const CONFIG_OVERRIDE_PATH =
