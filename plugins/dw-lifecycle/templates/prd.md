...
- [ ] [Second criterion — prefer observable behavior over internal implementation]
- [ ] [Third criterion — include a verification path where possible]

## Out of Scope

- [Capability or change that is explicitly NOT part of this feature]
- [Adjacent concern that may come later but is deferred here]
