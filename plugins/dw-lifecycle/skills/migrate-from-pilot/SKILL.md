...
3. **Wire the hooks + agent prompts.** Run `/dw-lifecycle:install-scope-discovery-hooks` and `/dw-lifecycle:install-agent-prompts` after the migration to land the pre-commit chain and the agent Step 0 mirrors.
