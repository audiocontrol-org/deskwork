...
- from: designing
- to: specifying
- exit-gate: section-present design problem-domain; section-present design solution-space; count-gte solution-space-alternatives 2; approval-marker design-approved
