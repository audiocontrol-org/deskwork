...
- US1 isolation probe RED→green + installation threading: 2d6807d5 (RED), 6b9cfa38 (T003), e0399339/2a53ccb3 (T004 flag retirement), b3311458 (T005 full verb table).
- US2 uniform refusal: 4d072352 (RED), fcf04440 (T007).
- US3 govern anchoring + cross-tree fold: 9c0cc5b2 (RED), bc3da087 (T009; TASK-40 excludePaths-from-record closed).
- US4 cwd invariance + slush destination: a1b61946 (RED), c04d7282 (T011).
- US5 legacy half-installation notice: 247e8515 (RED), 1f9112b2 (T013); this repo's root half-installation retired: f8255d51 + fc4869da (T014; gitignore depth fix).
- US6 installation-aware feature-root resolver: 8e38252a (RED), b619aea6 (T016); Spec Kit root relocated into the installation: a586a84e (T017); constitution 1.3.0 installation-anchor invariant: bd4cc9e5 (T018).
