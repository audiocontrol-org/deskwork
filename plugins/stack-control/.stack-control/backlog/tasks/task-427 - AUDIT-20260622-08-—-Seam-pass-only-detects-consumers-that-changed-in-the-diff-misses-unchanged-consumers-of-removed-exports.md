...
<!-- SECTION:NOTES:BEGIN -->
Closed: superseded by reframing: interface contracts belong to the compiler/test floor, not the stochastic seam pass; the unchanged-consumer gap vanishes by construction. See multi:gap/retire-seam-pass-interface-check.
<!-- SECTION:NOTES:END -->
