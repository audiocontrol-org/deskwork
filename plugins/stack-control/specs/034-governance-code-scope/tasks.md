...
- [ ] T020 [P] Final gate: `npx tsc --noEmit` clean + `npx vitest` green across the new suites; confirm `code-scope.ts` **and** `govern-arms.ts` (modified by T008/T017) remain under the file-size cap. (Constitution I, VI)
