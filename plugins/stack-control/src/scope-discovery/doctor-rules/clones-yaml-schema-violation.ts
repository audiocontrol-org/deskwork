/**
 * plugins/stack-control/src/scope-discovery/doctor-rules/clones-yaml-schema-violation.ts
 *
...
const SCHEMA_REL =
  'plugins/stack-control/src/scope-discovery/schema/clones.yaml.schema.json';
