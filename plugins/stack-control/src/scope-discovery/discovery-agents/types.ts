/**
 * plugins/stack-control/src/scope-discovery/discovery-agents/types.ts
 *
 * Shared types for the discovery-agent fleet. The fleet is a group of
 * TypeScript modules — NOT Claude Code sub-agents — that the
 * `stackctl scope-inventory` subcommand invokes in parallel; the
