/**
 * plugins/stack-control/src/scope-discovery/discovery-agents/codebase-state-metrics-gather.ts
 *
 ...
 *   - `.stack-control/scope-discovery/pattern-matrix-patterns.yaml` (override)
...
const CONFIG_DIR = '.stack-control/scope-discovery';
