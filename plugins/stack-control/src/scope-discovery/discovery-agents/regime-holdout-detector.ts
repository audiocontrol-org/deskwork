/**
 * plugins/stack-control/src/scope-discovery/discovery-agents/regime-holdout-detector.ts
 *
 ...
 * `<repoRoot>/.stack-control/scope-discovery/`. Standalone CLI
 ...
 * # CLI
 *
 *   tsx plugins/stack-control/src/scope-discovery/discovery-agents/regime-holdout-detector.ts \
 ...
 * config lives under `.stack-control/scope-discovery/` (not the legacy
 * `docs/scope-discovery/` location).
 */
const ANTI_PATTERNS_REGISTRY = '.stack-control/scope-discovery/anti-patterns.yaml';
const ADOPTER_MANIFESTS_REGISTRY = '.stack-control/scope-discovery/adopter-manifests.yaml';
...
async function collectAntiPatternFindings(
  ...
  // Internal library scan — ScanInput is just (registryPath, scanRoot).
