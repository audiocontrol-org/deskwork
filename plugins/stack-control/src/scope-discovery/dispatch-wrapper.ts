/**
 * plugins/stack-control/src/scope-discovery/dispatch-wrapper.ts
 *
 ...
 * stack-control skills or by external orchestrators that import
 * the stack-control plugin's scope-discovery modules.
 *
 ...
 *
 * Project overrides:
 *   - `.stack-control/scope-discovery/forbidden-deferral-phrases.yaml`
 *     replaces FORBIDDEN_DEFERRAL_PHRASES + FORBIDDEN_DEFERRAL_REGEXES
 *     (no merge — the project owns the full list).
 *   - `.stack-control/scope-discovery/refactor-markers.yaml` replaces
...
export interface WrapOptions {
  ...
  /**
   * Project root to resolve `.stack-control/scope-discovery/*.yaml`
...
const REFACTOR_MARKERS_OVERRIDE_PATH =
  '.stack-control/scope-discovery/refactor-markers.yaml';
