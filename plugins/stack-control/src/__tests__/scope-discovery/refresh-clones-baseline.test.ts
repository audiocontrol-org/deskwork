/**
 * plugins/stack-control/src/__tests__/scope-discovery/refresh-clones-baseline.test.ts
 *
 * Tests for the refresh-clones-baseline wrapper (ported from dw-lifecycle,
 * 010 US2). The wrapper's contract is small:
 *
