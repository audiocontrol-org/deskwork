 ...
 *
 * Scenarios:
 *   - Empty repo (no docs/, no .stack-control/scope-discovery/) → 0
 *     findings.
 ...
 *     .stack-control/scope-discovery/scope-manifest.yaml with the
...
describe('legacy-editor-symmetry-field-rename doctor rule', () => {
  ...
  it('project-root .stack-control/scope-discovery/scope-manifest.yaml with legacy field → finding emitted', async () => {
    const projectConfigDir = join(repoRoot, '.stack-control', 'scope-discovery');
