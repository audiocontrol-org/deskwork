...
- **Migrations.** scope-discovery → audit-barrage (governance in-house; one-way seam survives) → session-start/session-end move out of `dw-lifecycle` into `stack-control`.
