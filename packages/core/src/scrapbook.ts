 ...
 * Mirrors `createScrapbookMarkdown` but takes the dir directly.
 */
...
/**
 * Rename a file inside an already-resolved scrapbook dir. Mirrors
 * `renameScrapbookFile`.
 */
...
/**
 * Delete a file inside an already-resolved scrapbook dir. Mirrors
 * `deleteScrapbookFile`.
 */
