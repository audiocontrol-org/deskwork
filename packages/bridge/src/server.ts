 ...
 *
 * Phase 10b deliverable: a working `deskwork-bridge` bin. The studio
 * still mounts the same surface in single-process mode (10c flips it).
 *
 * Usage:
 ...
 *   --port          47321  (matches today's studio canonical port)
