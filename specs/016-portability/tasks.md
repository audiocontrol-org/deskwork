...
**Input**: Design documents from `/specs/016-portability/`
...
- [ ] T001 Audit the current portability seams in `plugins/stack-control/skills/` and `plugins/stack-control/src/subcommands/` against the `016-portability` contracts.
...
- [ ] T033 [P] Run the quickstart scenarios in `specs/016-portability/quickstart.md` and record results.
