...
- **Capture-don't-cut honored**: four out-of-scope boundaries recorded in Assumptions (dw-lifecycle ceremony, refuse-to-end gates, the resolver itself, retire-dw-lifecycle) rather than silently omitted. Four genuine operator-owned forks captured as Open Questions (OQ-1..OQ-4) with recommended defaults rather than invented NEEDS CLARIFICATION markers — **all four resolved in `/speckit-clarify` Session 2026-06-10** (all accepted the recommended default; see spec § Clarifications).
