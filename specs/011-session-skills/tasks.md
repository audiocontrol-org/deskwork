...
- [X] T037 Surface to the operator (do NOT auto-decide): (a) the **009 build-order sequencing** (plan § Dependency-sequencing) and (b) the **backlog changed-since** question (plan § Scope-coordination) — for a `roadmap reconcile` decision.
