...
7. **Check open GitHub issues**:
   - Run: `gh issue list --state open`

8. **Plan sub-agent delegation for the proposed goal:**
...
9. **Report to the user**:
   ...
   - If the proposed goal involves studio UI: cite the relevant section(s) of `docs/studio-design-standards.md` so it's clear which decisions are settled vs in-play
